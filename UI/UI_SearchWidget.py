...
class Ui_searchWidget(object):
    def setupUi(self, searchWidget):
        ...
        self.comBox_WhatCondition = QtWidgets.QComboBox(self.widget_3)
        self.comBox_WhatCondition.setMinimumSize(QtCore.QSize(70, 28))
        self.comBox_WhatCondition.setStyleSheet("margin-right:0px;")
        self.comBox_WhatCondition.setObjectName("comBox_WhatCondition")
        self.comBox_WhatCondition.addItem("")
        self.comBox_WhatCondition.addItem("")
        self.comBox_WhatCondition.addItem("")
        self.comBox_WhatCondition.addItem("")
        self.comBox_WhatCondition.addItem("")
        self.comBox_WhatCondition.addItem("")
        self.horizontalLayout_2.addWidget(self.comBox_WhatCondition)
        ...
        self.btn_Search.setStyleSheet("margin-left:0px;")
        icon = QtGui.QIcon()
...
"}")
        ...
        self.comBox_WhatCondition.setCurrentIndex(5)
    ...
    def retranslateUi(self, searchWidget):
        ...
        self.lineEdit_WhatSearch.setPlaceholderText(_translate("searchWidget", "请输入您要搜索的关键字词"))
        self.comBox_WhatCondition.setItemText(0, _translate("searchWidget", "标题"))
        self.comBox_WhatCondition.setItemText(1, _translate("searchWidget", "作者"))
        self.comBox_WhatCondition.setItemText(2, _translate("searchWidget", "关键字"))
        self.comBox_WhatCondition.setItemText(3, _translate("searchWidget", "主要内容"))
        self.comBox_WhatCondition.setItemText(4, _translate("searchWidget", "年份"))
        self.comBox_WhatCondition.setItemText(5, _translate("searchWidget", "模糊查询"))
